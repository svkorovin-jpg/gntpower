      ...
      <section className="py-12 px-6 bg-white border-t border-[#EDEDED]">
        <div className="max-w-[860px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              { url: "/ua/otsinka-upravlinskoho-potentsialu", label: "Оцінка управлінського потенціалу" },
              { url: "/ua/soft-skills-kerivnyka", label: "Soft skills керівника" },
              { url: "/ua/yak-vyznachyty-lideriv-u-komandi", label: "Як визначити лідерів у команді" },
