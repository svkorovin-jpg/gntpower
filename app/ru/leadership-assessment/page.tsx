      ...
      <section className="py-12 px-6 bg-white border-t border-[#EDEDED]">
        <div className="max-w-[860px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              { url: "/ru/ocenka-upravlencheskogo-potenciala", label: "Оценка управленческого потенциала" },
              { url: "/ru/soft-skills-rukovoditelya", label: "Soft skills руководителя" },
              { url: "/ru/kak-opredelit-liderov-v-komande", label: "Как определить лидеров в команде" },
